...
if command -v exa &> /dev/null; then
    alias ls="exa"
    alias ll="exa -l --time-style=long-iso -s time"
    alias llt="exa -l --time-style=long-iso -s time"
    alias lls="exa -l --time-style=long-iso -s size"
    alias lln="exa -l --time-style=long-iso -s name"
    alias lh="exa -l --time-style=long-iso -s name"
    alias la="exa -aF"
else
    alias ls="ls --color"
    alias ll="ls -l --color"
