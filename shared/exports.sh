...
export PATH="${PATH}:/home/wangxiao/.local/bin"
export PATH="${PATH}:/home/wangxiao/.gem/ruby/2.6.0/bin"
alias vim="nvim"

export TERM="xterm-256color"
#export PATH="/home/wangxiao/bin/:${PATH}"
export PATH="/home/wangxiao/.cargo/bin:${PATH}"
...
export SSLKEYLOGFILE="/home/wangxiao/.local/tls/ssl_log.log"

export CONSUL_HTTP_ADDR=https://consul.athenacle.xyz:8501
export CONSUL_CACERT='/home/wangxiao/gits/configuration/consul/ca/athenacle.xyz-agent-ca.pem'
export CONSUL_CLIENT_CERT='/home/wangxiao/gits/configuration/consul/ca/dc1-client-athenacle.xyz-0.pem'
export CONSUL_CLIENT_KEY='/home/wangxiao/gits/configuration/consul/ca/dc1-client-athenacle.xyz-0-key.pem'
export CONSUL_HTTP_TOKEN=83f9e464-f038-eb35-a1a8-276b02424d28
